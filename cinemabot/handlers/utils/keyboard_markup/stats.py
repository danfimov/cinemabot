...
def construct_keyboard_markup_for_stats(
    ...
    # Создаем кнопки
    button_prev = InlineKeyboardButton(text="Назад", callback_data="stats_command_prev_button")
    button_next = InlineKeyboardButton(text="Вперёд", callback_data="stats_command_next_button")
