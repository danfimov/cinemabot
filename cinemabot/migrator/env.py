...
from cinemabot.database.base import DeclarativeBase
from cinemabot.database.models import *  # noqa
...
config.set_section_option(section, "SSL_MODE", settings.SSL_MODE)
